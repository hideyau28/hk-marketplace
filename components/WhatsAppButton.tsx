...
export default function WhatsAppButton({ t }: { t: Translations }) {
  ...
  return (
    <a
      ...
      rel="noreferrer"
      aria-label="WhatsApp"
      className="fixed bottom-20 right-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:scale-105 transition-transform"
    >
