...
const T = {
  "zh-HK": {
    ...
    pricingFreeFeat3: "3 款收款方式（FPS・PayMe・AlipayHK）",
  ...
  en: {
    ...
    pricingFreeFeat3: "3 payment methods (FPS · PayMe · AlipayHK)",
    ...
    pricingLiteFeat3: "All 7 payment methods",
    ...
    pricingProFeat3: "All 7 payment methods",
