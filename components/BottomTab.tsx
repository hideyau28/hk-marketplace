...
export default function BottomTab({ t }: { t: Translations }) {
  ...
  return (
    <nav className="md:hidden fixed inset-x-0 bottom-0 z-50 border-t border-zinc-200 bg-white/90 backdrop-blur pb-[env(safe-area-inset-bottom)] dark:border-zinc-800 dark:bg-zinc-950/90">
