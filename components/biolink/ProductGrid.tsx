...
export default function ProductGrid({ products, currency, onAdd, onImageTap, searchQuery, textColor = "#18181B" }: Props) {
  ...
  return (
    <section className="px-4 py-6">
      <h2 className="text-base font-bold mb-4" style={{ color: textColor }}>全部商品</h2>
