...
export default function ProfileSection({ tenant }: Props) {
  ...
  return (
    <div className="relative -mt-12 px-5 pb-4">
      ...
      {/* Social buttons */}
      {(tenant.whatsapp || tenant.instagram || tenant.facebook) && (
        <div className="flex justify-center gap-3 mt-3">
          ...
          {tenant.instagram && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#E4405F]/10 text-[#E4405F] text-xs font-medium hover:bg-[#E4405F]/20 transition-colors"
            >
              <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
          ...
          {tenant.facebook && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#1877F2]/10 text-[#1877F2] text-xs font-medium hover:bg-[#1877F2]/20 transition-colors"
            >
              <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
