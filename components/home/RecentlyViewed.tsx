      ...
      <div className="relative w-[120px]">
        ...
        {showCartIcon && selectedSize && (
          <button
            ...
            className="absolute bottom-12 right-2 w-8 h-8 rounded-full text-white flex items-center justify-center shadow-md hover:brightness-90 transition-all z-10"
