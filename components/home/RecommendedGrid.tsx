...
function ProductCardItem({
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-[160px] min-w-[160px] md:w-[180px] md:min-w-[180px] overflow-hidden rounded-xl bg-white border shadow-sm hover:shadow-md transition-shadow dark:bg-zinc-900 ${isOnSale ? "border-red-200 ring-1 ring-red-200 dark:border-red-900/50 dark:ring-red-900/50" : "border-zinc-200/50 dark:border-zinc-800"}`}
      >
