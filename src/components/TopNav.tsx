  ...
  return (
    <div className="sticky top-0 z-50 border-b border-white/10 bg-black/70 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center gap-3 px-4 py-3">
        <Link href={`/${locale}`} className="text-white font-semibold tracking-wide">{defaultStore.storeName}</Link>
        ...
        <div className="flex items-center gap-2 text-sm">
          ...
          <Link className="text-white/70 hover:text-white" href={`/${locale}/admin/orders`}>Orders(Admin)</Link>
        </div>
