...
export async function createProduct(
  data: { brand: string; title: string; price: number; imageUrl?: string; badges?: string; promotionBadges?: string[]; category?: string | null; active?: boolean },
  locale?: string
...
export async function updateProduct(
  productId: string,
  data: { brand?: string | null; title?: string; price?: number; imageUrl?: string | null; badges?: string; promotionBadges?: string[]; category?: string | null; active?: boolean },
  locale?: string
