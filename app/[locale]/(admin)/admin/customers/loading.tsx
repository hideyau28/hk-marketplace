  ...
  return (
    <div className="pl-16 pr-4 pb-16 pt-4">
      ...
      <div className="mt-4 flex gap-2">
        <div className="h-9 w-20 bg-wlx-mist rounded-full animate-pulse"></div>
        <div className="h-9 w-24 bg-wlx-mist rounded-full animate-pulse"></div>
      </div>
          ...
          >
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="space-y-2 text-right">
                <div className="h-5 w-16 bg-wlx-mist rounded animate-pulse ml-auto"></div>
                <div className="h-3 w-12 bg-wlx-mist rounded animate-pulse ml-auto"></div>
              </div>
            </div>
          </div>
        ))}
