  ...
  return (
    <div className="p-4 pb-16 max-w-full overflow-hidden">
      <div className="flex items-center gap-4 mb-6">
        <SidebarToggle />
        <div>
          <h1 className="text-2xl font-semibold text-wlx-ink">數據分析</h1>
      ...
      {analyticsEnabled ? (
        ...
        <div className="mt-8 rounded-2xl border border-wlx-mist bg-wlx-cream p-8 text-center">
          ...
          <h3 className="text-lg font-semibold text-wlx-ink mb-2">
            升級解鎖數據分析
          </h3>
          <p className="text-sm text-wlx-stone max-w-md mx-auto mb-4">
            升級至 Lite 或 Pro 計劃，即可查看訂單趨勢、收入報表同熱門商品排行。
          </p>
          <Link
            href={`/${locale}/admin/billing`}
            className="inline-flex items-center gap-2 rounded-xl bg-wlx-ink px-6 py-3 text-sm font-medium text-white hover:bg-zinc-800 transition-colors"
          >
            查看計劃
          </Link>
        </div>
