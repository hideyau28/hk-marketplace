  ...
  return (
    <div className="px-4 pb-16 pt-4 pl-16">
      ...
      <div className="mt-6 flex items-center justify-between gap-3">
        <div className="h-12 w-48 bg-wlx-mist rounded-2xl animate-pulse"></div>
        <div className="h-12 w-32 bg-wlx-mist rounded-xl animate-pulse"></div>
      </div>
        ...
        <div className="p-4 space-y-4">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="flex items-center gap-4 p-4 border-b border-wlx-mist last:border-0">
              <div className="h-12 w-12 bg-wlx-mist rounded-xl animate-pulse"></div>
              <div className="flex-1 space-y-2">
                <div className="h-4 w-48 bg-wlx-mist rounded animate-pulse"></div>
                <div className="h-3 w-32 bg-wlx-mist rounded animate-pulse"></div>
              </div>
