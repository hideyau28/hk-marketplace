  ...
  return (
    <div className="px-4 pb-16 pt-4 pl-16">
      ...
      <div className="mt-6 grid grid-cols-3 gap-4">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="rounded-3xl border border-wlx-mist bg-white p-6 space-y-3">
            <div className="h-4 w-24 bg-wlx-mist rounded animate-pulse"></div>
            <div className="h-8 w-32 bg-wlx-mist rounded animate-pulse"></div>
            <div className="h-3 w-40 bg-wlx-mist rounded animate-pulse"></div>
          </div>
        ))}
      </div>
          ...
          {[...Array(6)].map((_, i) => (
            <div key={i} className="flex items-center gap-4 p-4 border-b border-wlx-mist last:border-0">
              <div className="flex-1 space-y-2">
                ...
                <div className="h-3 w-28 bg-wlx-mist rounded animate-pulse"></div>
              </div>
