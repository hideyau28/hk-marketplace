...
mkdir -p src/messages src/lib src/components src/app/[locale]/product/[id]

cat > src/messages/zh-HK.json <<'EOM'
{
...
cat > src/components/TopNav.tsx <<'EOM'
"use client";
...
cat > src/components/ProductCard.tsx <<'EOM'
import Link from "next/link";
import type { Locale } from "@/lib/i18n";
...
cat > src/components/ShelfRow.tsx <<'EOM'
import type { Locale } from "@/lib/i18n";
...
cat > src/app/[locale]/layout.tsx <<'EOM'
...
cat > src/app/[locale]/page.tsx <<'EOM'
import { getDict, type Locale } from "@/lib/i18n";
...
cat > src/app/[locale]/product/[id]/page.tsx <<'EOM'
import { getDict, type Locale } from "@/lib/i18n";
import { mockProducts } from "@/lib/mock";
    ...
    <div className="px-4 pb-24 pt-6">
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-4 text-white/60 text-sm leading-6">
